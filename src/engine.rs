...
use web_sys::{CanvasRenderingContext2d, HtmlImageElement, Response, AudioContext, AudioBuffer, HtmlElement};
...
impl Rect{
    ...
    pub const fn new_from_x_y(x: i16, y: i16, width: i16, height: i16) -> Self{
        Rect{position: Point{x, y}, width, height}
    }
